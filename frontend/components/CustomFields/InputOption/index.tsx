  ...
  return (
    <div className="d-flex align-items-center">
      ...
      <div className={styles.option}>
        ...
        <Trash className={styles.optionDelete} onClick={() => onDelete(1)} />
      </div>
      <div className="flex-fill">
        <Form.Group controlId={name} className={styles.text}>
          {labelOption && (
            <Form.Label className={styles.formLabel}>{labelOption}</Form.Label>
          )}
          <Form.Control
            type={type}
        ...
        <Form.Group controlId={name} className={styles.text}>
          {labelExplain && (
            <Form.Label className={styles.formLabel}>{labelExplain}</Form.Label>
          )}
          <Form.Control
            type={type}
