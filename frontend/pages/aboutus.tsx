...
function AboutUs() {
  const output = `
    <!DOCTYPE html>
    <html>
    <title>About US | TD4School</title>
    <head>
<style>
img {
	width: 100%;
...
floor {
	...
	background: linear-gradient(#000, rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)), repeating-linear-gradient(to right, rgba(255, 255, 255, 0), rgba(255, 255, 255, 0) 12rem, rgba(17, 14, 18, 0.5) 12.5rem), radial-gradient(#d9996a, #361f0e);
}
...
<z>
  <x>
    <y>
      ...
      <wall3>
        <painting>
          <img src="https://raw.githubusercontent.com/ntvy2k/DA_04/master/frontend/public/TanSang.jpg" />
          <p>
            Võ Tấn Sang<br />
            Vua dịch thuật<br />
            <small>Ben Evans</small>
